    ...
    <div className={`relative w-full h-full flex items-center justify-center aspect-square ${className}`}>
        ...
        <defs>
          <filter id="neon-blue" x="-200%" y="-200%" width="500%" height="500%">
            ...
            <feDropShadow dx="0" dy="0" stdDeviation="3" floodColor="#0088cc" floodOpacity="0.7" mode="screen"/>
            <feDropShadow dx="0" dy="0" stdDeviation="6" floodColor="#0088cc" floodOpacity="0.5" mode="screen"/>
            <feDropShadow dx="0" dy="0" stdDeviation="10" floodColor="#0088cc" floodOpacity="0.3" mode="screen"/>
          </filter>
          <filter id="neon-pink" x="-200%" y="-200%" width="500%" height="500%">
            ...
            <feDropShadow dx="0" dy="0" stdDeviation="3" floodColor="#e80dfb" floodOpacity="0.7" mode="screen"/>
            <feDropShadow dx="0" dy="0" stdDeviation="6" floodColor="#e80dfb" floodOpacity="0.5" mode="screen"/>
            <feDropShadow dx="0" dy="0" stdDeviation="10" floodColor="#e80dfb" floodOpacity="0.3" mode="screen"/>
          </filter>
